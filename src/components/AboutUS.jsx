    ...
    <div className="container1" id="about">
      ...
      <div className="screen-container">
        ...
        <div className="sleep-cat">
          ...
          >
            <path
              d="M8 0H2V1H6V2H4V4H2V5H8V4H5V3H6V2H7V1H8V0Z"
              fill="currentColor"
            />
            ...
            <div className="top-buttons">
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M40 0H56V16H40V0ZM41 1V15H55V1H41Z"
                  fill="currentColor"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M0 0H16V16H0V0ZM1 1V15H15V1H1Z"
                  fill="currentColor"
                />
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M20 0H36V16H20V0ZM21 1V15H35V1H21Z"
                  fill="currentColor"
                />
                <path
                  fill-rule="evenodd"
          ...
          <div className="main-window">
            <div className="small-window">
              <p className="first-p">
                ...
                products that brings about positive change in society. We
                conduct mentorship sessions, workshops, knowledge transfer
                sessions, hackathons, coding contests, open source programs,
                etc. where students from across the globe get to showcase their
                knowledge and develop their skillset.
              </p>
        ...
        <div className="windows-container">
          <div className="right-window-container">
            <div className="top-right-window">
