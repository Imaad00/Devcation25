...
const Header = () => {
  const Join = () => {
    window.location.href = "https://unstop.com/college-fests/devcation25-gdg-on-campus-igdtuw-indira-gandhi-delhi-technical-university-for-women-igdtuw-delhi-368807";
  };
  return (
    ...
    <div className="header-container" id="header">
      <div className="text-container">
        ...
        <h2 className="title textDev">Devcation`25</h2>
      ...
      <div className="image-container">
        ...
        <img src="hero.webp" alt="header" className="image" />
