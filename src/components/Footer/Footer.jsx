  ...
  return (
    <footer id="contact">
      <div className="footer-cta pt-5 pb-5">
        <div className="flex items-center lg:space-x-64 md:space-x-16">
          <div className="col-xl-4 col-md-4 sm:text-left w-1/3 ">
            <a
              href="https://discord.com/invite/eG4YP3gA48"
              target="_blank"
          ...
          <div className="col-xl-4 col-md-4 mb-30 text-left sm:text-left w-1/3">
            <a href="https://chat.whatsapp.com/KIlPsKeZZdo7KhKtilL8AT" className="cta-link">
              <div className="single-cta">
      ...
      <div className="footerContainer">
        ...
        <a href="https://x.com/gdsc_igdtuw" target="_blank" className="twitter" style={{"marginLeft":"3px"}}> <Icon className="icon"color="primary" component={XIcon} style={{"width":"40px","height":"30px", "color":"#1BB1DC"}} /> </a> 
